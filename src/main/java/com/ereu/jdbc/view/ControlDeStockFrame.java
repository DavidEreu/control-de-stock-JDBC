...
import com.ereu.jdbc.controller.CategoriaController;
import com.ereu.jdbc.controller.ProductoController;
...
public class ControlDeStockFrame extends JFrame {
    ...
    private void configurarTablaDeContenido(Container container) {
        ...
        botonModificar.setBounds(100, 500, 88, 20);
        botonReporte.setBounds(199, 500, 102, 20);
    ...
    private void eliminar() {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    Integer id = Integer.valueOf( modelo.getValueAt(tabla.getSelectedRow(),0).toString());
                    int cantidadElimindada;

                    cantidadElimindada = this.productoController.eliminar(id);

                    modelo.removeRow(tabla.getSelectedRow());

                    JOptionPane.showMessageDialog(this, cantidadElimindada + " Item eliminado con éxito!");
                }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
    }
